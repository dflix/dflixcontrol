...
<div class="col-md-12">
   ...
   <a href="/dashboard/entradas/create"><button class="btn btn-success">ENTRADAS</button></a> 
</div>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="/dashboard/entradas/update/{{$valor->id}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
            <td><a href="/dashboard/entradas/destroy/{{$valor->id}}"><i class="fa-solid fa-trash-can"></i></a></td>
            </tr>
            @endforeach
        </tbody>
